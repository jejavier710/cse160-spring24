...
class Vector3 {
    ...
    // Note: I used ChatGPT to help me figure out add, sub, mul, and div
    ...
    static cross(other1, other2) {
        ...
        const i = oth1[1]*oth2[2] - oth1[2]*oth2[1];
        const j = -1*(oth1[0]*oth2[2]-oth1[2]*oth2[0]);
        const k = (oth1[0]*oth2[1]-oth1[1]*oth2[0]);
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        // Note: Used ChatGPT to help with this
        var vec1 = this.elements;
        var magni = this.magnitude();
